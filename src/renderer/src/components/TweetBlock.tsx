        ...
        <div className="tweet-editor-stage">
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    {mediaPath && (
                        <span style={{ marginLeft: '1rem', fontSize: '0.9rem', color: 'var(--text-secondary)' }}>
                            ...
                            <button
                                ...
                                style={{ background: 'none', border: 'none', color: 'var(--error)', cursor: 'pointer', padding: '0 0.5rem' }}
                            >
                                ✕
                            </button>
                        </span>
                ...
                <div style={{ textAlign: 'right' }}>
                    <div style={{ fontSize: '1rem', fontWeight: 'bold', color: isOverLimit ? '#ff4444' : 'var(--text-secondary)' }}>
                        {charCount} / {maxChars}
                    </div>
